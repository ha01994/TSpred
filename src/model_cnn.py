...
class cnnmodel(nn.Module):
    ...
    def forward(self, pep,a1,a2,a3,b1,b2,b3):
        ...
        pep1 = self.cnn_pep_1(pep).view(bsz, -1)
        a11 = self.cnn_a1_1(a1).view(bsz, -1)
        a21 = self.cnn_a2_1(a2).view(bsz, -1)
        a31 = self.cnn_a3_1(a3).view(bsz, -1)
        b11 = self.cnn_b1_1(b1).view(bsz, -1)
        b21 = self.cnn_b2_1(b2).view(bsz, -1)
        b31 = self.cnn_b3_1(b3).view(bsz, -1)
